...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable
{
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V>
    {
        ...
        Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(map.entrySet().spliterator(), (Function<? super Map.Entry<C, V>, ? extends Map.Entry<C, V>>)this::wrapEntry);
        }
    ...
    class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>>
    {
        ...
        class EntrySet extends TableSet<Map.Entry<R, Map<C, V>>>
        {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), (rp.com.google.common.base.Function<? super R, Map<C, V>>)new rp.com.google.common.base.Function<R, Map<C, V>>() {
                    @Override
    ...
    private class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>>
    {
        ...
        class ColumnMapEntrySet extends TableSet<Map.Entry<C, Map<R, V>>>
        {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), (rp.com.google.common.base.Function<? super C, Map<R, V>>)new rp.com.google.common.base.Function<C, Map<R, V>>() {
                    @Override
