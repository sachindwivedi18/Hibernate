...
import rp.com.google.common.base.Converter;
...
public final class Maps
{
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> keyFunction, final java.util.function.Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(() -> new Accumulator((v1, v2) -> {
            new IllegalArgumentException("Multiple values for key: " + v1 + ", " + v2);
            throw ex;
        }), (accum, t) -> {
            key = Preconditions.checkNotNull((K)keyFunction.apply((Object)t), "Null key for input %s", t);
            newValue = Preconditions.checkNotNull((V)valueFunction.apply((Object)t), "Null value for input %s", t);
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> keyFunction, final java.util.function.Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction) {
        ...
        final K key;
        final V newValue;
        return Collector.of(() -> new Accumulator((BinaryOperator<Object>)mergeFunction), (accum, t) -> {
            key = Preconditions.checkNotNull((K)keyFunction.apply((Object)t), "Null key for input %s", t);
            newValue = Preconditions.checkNotNull((V)valueFunction.apply((Object)t), "Null value for input %s", t);
            accum.put((Enum)key, newValue);
    ...
    public static <C, K extends C, V> TreeMap<K, V> newTreeMap(final Comparator<C> comparator) {
    ...
    static <E> Comparator<? super E> orNaturalOrder(final Comparator<? super E> comparator) {
        if (comparator != null) {
            return comparator;
        }
    ...
    private static <K, V> Map.Entry<K, V> unmodifiableOrNull(final Map.Entry<K, ? extends V> entry) {
    ...
    static boolean containsKeyImpl(final Map<?, ?> map, final Object key) {
        return Iterators.contains(keyIterator(map.entrySet().iterator()), key);
    }
    
    static boolean containsValueImpl(final Map<?, ?> map, final Object value) {
    ...
    static <V> V valueOrNull(final Map.Entry<?, V> entry) {
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V>
    {
        ...
        static <V> MapDifference.ValueDifference<V> create(final V left, final V right) {
            return new ValueDifferenceImpl<V>(left, right);
        }
        
        private ValueDifferenceImpl(final V left, final V right) {
            this.left = left;
            this.right = right;
        }
    ...
    private static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V>
    {
        ...
        public void forEach(final BiConsumer<? super K, ? super V> action) {
            ...
            this.backingSet().forEach(k -> action.accept((Object)k, (Object)this.function.apply((Object)k)));
        }
    }
    ...
    private static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V>
    {
        ...
        @Override
        public void forEach(final BiConsumer<? super K, ? super V> action) {
            this.set.forEach(k -> action.accept((Object)k, (Object)this.function.apply((Object)k)));
        }
    ...
    private static class UnmodifiableBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable
    {
        ...
        UnmodifiableBiMap(final BiMap<? extends K, ? extends V> delegate, final BiMap<V, K> inverse) {
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2>
    {
        ...
        @Override
        public V2 getOrDefault(final Object key, final V2 defaultValue) {
            final V1 value = this.fromMap.get(key);
            return (value != null || this.fromMap.containsKey(key)) ? this.transformer.transformEntry((Object)key, (Object)value) : defaultValue;
        }
        ...
        public void forEach(final BiConsumer<? super K, ? super V2> action) {
            Preconditions.checkNotNull(action);
            this.fromMap.forEach((k, v1) -> action.accept((Object)k, (Object)this.transformer.transformEntry((Object)k, (Object)v1)));
        }
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2>
    {
        ...
        private Map.Entry<K, V2> transformEntry(final Map.Entry<K, V1> entry) {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V>
    {
        ...
        public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> function) {
            this.unfiltered().replaceAll((key, value) -> this.predicate.apply(Maps.immutableEntry(key, value)) ? function.apply((Object)key, (Object)value) : value);
        }
    ...
    {
        V2 transformEntry(final K p0, final V1 p1);
    }
}
