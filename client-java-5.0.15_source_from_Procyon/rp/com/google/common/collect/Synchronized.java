...
final class Synchronized
{
    ...
    private static <E> Collection<E> collection(final Collection<E> collection, final Object mutex) {
        return new SynchronizedCollection<E>((Collection)collection, mutex);
    }
    
    @VisibleForTesting
    static <E> Set<E> set(final Set<E> set, final Object mutex) {
        return new SynchronizedSet<E>(set, mutex);
    }
    
    private static <E> SortedSet<E> sortedSet(final SortedSet<E> set, final Object mutex) {
        return new SynchronizedSortedSet<E>(set, mutex);
    }
    
    private static <E> List<E> list(final List<E> list, final Object mutex) {
        return (list instanceof RandomAccess) ? new SynchronizedRandomAccessList<E>(list, mutex) : new SynchronizedList<E>(list, mutex);
    }
    
    static <E> Multiset<E> multiset(final Multiset<E> multiset, final Object mutex) {
    ...
    static <K, V> Multimap<K, V> multimap(final Multimap<K, V> multimap, final Object mutex) {
    ...
    static <K, V> ListMultimap<K, V> listMultimap(final ListMultimap<K, V> multimap, final Object mutex) {
    ...
    static <K, V> SetMultimap<K, V> setMultimap(final SetMultimap<K, V> multimap, final Object mutex) {
    ...
    static <K, V> SortedSetMultimap<K, V> sortedSetMultimap(final SortedSetMultimap<K, V> multimap, final Object mutex) {
    ...
    private static <E> Collection<E> typePreservingCollection(final Collection<E> collection, final Object mutex) {
    ...
    private static <E> Set<E> typePreservingSet(final Set<E> set, final Object mutex) {
    ...
    @VisibleForTesting
    static <K, V> Map<K, V> map(final Map<K, V> map, final Object mutex) {
        return new SynchronizedMap<K, V>(map, mutex);
    }
    
    static <K, V> SortedMap<K, V> sortedMap(final SortedMap<K, V> sortedMap, final Object mutex) {
        return new SynchronizedSortedMap<K, V>(sortedMap, mutex);
    }
    
    static <K, V> BiMap<K, V> biMap(final BiMap<K, V> bimap, final Object mutex) {
    ...
    @GwtIncompatible
    static <E> NavigableSet<E> navigableSet(final NavigableSet<E> navigableSet, final Object mutex) {
    ...
    @GwtIncompatible
    static <K, V> NavigableMap<K, V> navigableMap(final NavigableMap<K, V> navigableMap, final Object mutex) {
        return new SynchronizedNavigableMap<K, V>(navigableMap, mutex);
    }
    
    @GwtIncompatible
    private static <K, V> Map.Entry<K, V> nullableSynchronizedEntry(final Map.Entry<K, V> entry, final Object mutex) {
        if (entry == null) {
            return null;
        }
    ...
    static <E> Queue<E> queue(final Queue<E> queue, final Object mutex) {
        return (queue instanceof SynchronizedQueue) ? queue : new SynchronizedQueue<E>(queue, mutex);
    }
    
    static <E> Deque<E> deque(final Deque<E> deque, final Object mutex) {
    ...
    static class SynchronizedObject implements Serializable
    {
        ...
        SynchronizedObject(final Object delegate, final Object mutex) {
    ...
    static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E>
    {
        ...
        private SynchronizedCollection(final Collection<E> delegate, final Object mutex) {
    ...
    static class SynchronizedSet<E> extends SynchronizedCollection<E> implements Set<E>
    {
        ...
        SynchronizedSet(final Set<E> delegate, final Object mutex) {
    ...
    static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E>
    {
        ...
        SynchronizedSortedSet(final SortedSet<E> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E>
    {
        ...
        SynchronizedList(final List<E> delegate, final Object mutex) {
            super((Collection)delegate, mutex);
        }
    ...
    private static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E>
    {
        ...
        SynchronizedMultiset(final Multiset<E> delegate, final Object mutex) {
            super((Collection)delegate, mutex);
        }
    ...
    private static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V>
    {
        ...
        SynchronizedMultimap(final Multimap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V>
    {
        ...
        SynchronizedListMultimap(final ListMultimap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V>
    {
        ...
        SynchronizedSetMultimap(final SetMultimap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V>
    {
        ...
        SynchronizedSortedSetMultimap(final SortedSetMultimap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Map.Entry<K, Collection<V>>>
    {
        ...
        SynchronizedAsMapEntries(final Set<Map.Entry<K, Collection<V>>> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V>
    {
        ...
        SynchronizedMap(final Map<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V>
    {
        ...
        SynchronizedSortedMap(final SortedMap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable
    {
        ...
        private SynchronizedBiMap(final BiMap<K, V> delegate, final Object mutex, final BiMap<V, K> inverse) {
            super(delegate, mutex);
    ...
    private static class SynchronizedAsMap<K, V> extends SynchronizedMap<K, Collection<V>>
    {
        ...
        SynchronizedAsMap(final Map<K, Collection<V>> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>>
    {
        ...
        SynchronizedAsMapValues(final Collection<Collection<V>> delegate, final Object mutex) {
            super((Collection)delegate, mutex);
        }
    ...
    static class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E>
    {
        ...
        SynchronizedNavigableSet(final NavigableSet<E> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V>
    {
        ...
        SynchronizedNavigableMap(final NavigableMap<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedEntry<K, V> extends SynchronizedObject implements Map.Entry<K, V>
    {
        ...
        SynchronizedEntry(final Map.Entry<K, V> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static class SynchronizedQueue<E> extends SynchronizedCollection<E> implements Queue<E>
    {
        ...
        SynchronizedQueue(final Queue<E> delegate, final Object mutex) {
            super((Collection)delegate, mutex);
        }
    ...
    private static final class SynchronizedDeque<E> extends SynchronizedQueue<E> implements Deque<E>
    {
        ...
        SynchronizedDeque(final Deque<E> delegate, final Object mutex) {
            super(delegate, mutex);
        }
    ...
    private static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V>
    {
        ...
        public Map<R, Map<C, V>> rowMap() {
            synchronized (this.mutex) {
                return Synchronized.map((Map<R, Map<C, V>>)Maps.transformValues((Map<K, Map<C, V>>)this.delegate().rowMap(), (rp.com.google.common.base.Function<? super Map<C, V>, V>)new rp.com.google.common.base.Function<Map<C, V>, Map<C, V>>() {
                    @Override
        ...
        public Map<C, Map<R, V>> columnMap() {
            synchronized (this.mutex) {
                return Synchronized.map((Map<C, Map<R, V>>)Maps.transformValues((Map<K, Map<R, V>>)this.delegate().columnMap(), (rp.com.google.common.base.Function<? super Map<R, V>, V>)new rp.com.google.common.base.Function<Map<R, V>, Map<R, V>>() {
                    @Override
