...
public class SimpleLog implements Log, Serializable
{
    ...
    protected static final String systemPrefix = "rp.org.apache.commons.logging.simplelog.";
    ...
    public SimpleLog(String name) {
        ...
        this.logName = name;
        this.setLevel(3);
        String lvl = getStringProperty("rp.org.apache.commons.logging.simplelog.log." + this.logName);
        for (int i = String.valueOf(name).lastIndexOf("."); null == lvl && i > -1; lvl = getStringProperty("rp.org.apache.commons.logging.simplelog.log." + name), i = String.valueOf(name).lastIndexOf(".")) {
            name = name.substring(0, i);
        }
        if (null == lvl) {
            lvl = getStringProperty("rp.org.apache.commons.logging.simplelog.defaultlog");
        }
    ...
    static {
        ...
        SimpleLog.showLogName = getBooleanProperty("rp.org.apache.commons.logging.simplelog.showlogname", SimpleLog.showLogName);
        SimpleLog.showShortName = getBooleanProperty("rp.org.apache.commons.logging.simplelog.showShortLogname", SimpleLog.showShortName);
        SimpleLog.showDateTime = getBooleanProperty("rp.org.apache.commons.logging.simplelog.showdatetime", SimpleLog.showDateTime);
        if (SimpleLog.showDateTime) {
            SimpleLog.dateTimeFormat = getStringProperty("rp.org.apache.commons.logging.simplelog.dateTimeFormat", SimpleLog.dateTimeFormat);
            try {
