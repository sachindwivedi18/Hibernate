...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable
{
    ...
    private long aggregateBelowRange(final Aggregate aggr, final AvlNode<E> node) {
        if (node == null) {
            return 0L;
        }
    ...
    private long aggregateAboveRange(final Aggregate aggr, final AvlNode<E> node) {
        if (node == null) {
            return 0L;
        }
    ...
    static int distinctElements(final AvlNode<?> node) {
    ...
    private enum Aggregate
    {
        SIZE {
            ...
            @Override
            long treeAggregate(final AvlNode<?> root) {
        ...
        abstract long treeAggregate(final AvlNode<?> p0);
    }
    ...
    private static final class Reference<T>
    {
        ...
        public void checkAndSet(final T expected, final T newValue) {
    ...
    private static final class AvlNode<E>
    {
        ...
        AvlNode(final E elem, final int elemCount) {
        ...
        AvlNode<E> add(final Comparator<? super E> comparator, final E e, final int count, final int[] result) {
            final int cmp = comparator.compare((Object)e, (Object)this.elem);
            if (cmp < 0) {
        ...
        AvlNode<E> remove(final Comparator<? super E> comparator, final E e, final int count, final int[] result) {
            final int cmp = comparator.compare((Object)e, (Object)this.elem);
            if (cmp < 0) {
                final AvlNode<E> initLeft = this.left;
                if (initLeft == null) {
        ...
        AvlNode<E> setCount(final Comparator<? super E> comparator, final E e, final int count, final int[] result) {
            final int cmp = comparator.compare((Object)e, (Object)this.elem);
            if (cmp < 0) {
                final AvlNode<E> initLeft = this.left;
                if (initLeft == null) {
        ...
        AvlNode<E> setCount(final Comparator<? super E> comparator, final E e, final int expectedCount, final int newCount, final int[] result) {
            final int cmp = comparator.compare((Object)e, (Object)this.elem);
            if (cmp < 0) {
                final AvlNode<E> initLeft = this.left;
                if (initLeft != null) {
        ...
        private static long totalCount(final AvlNode<?> node) {
