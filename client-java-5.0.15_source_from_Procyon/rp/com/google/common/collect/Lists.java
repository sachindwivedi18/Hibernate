...
public final class Lists
{
    ...
    public static <E> List<E> asList(final E first, final E second, final E[] rest) {
    ...
    static boolean equalsImpl(final List<?> thisList, final Object other) {
    ...
    private static int indexOfRandomAccess(final List<?> list, final Object element) {
    ...
    private static int lastIndexOfRandomAccess(final List<?> list, final Object element) {
        if (element == null) {
    ...
    private static class OnePlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess
    {
        ...
        OnePlusArrayList(final E first, final E[] rest) {
            this.first = first;
    ...
    private static class TwoPlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess
    {
        ...
        TwoPlusArrayList(final E first, final E second, final E[] rest) {
            this.first = first;
            this.second = second;
            this.rest = Preconditions.checkNotNull(rest);
        }
    ...
    private static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable
    {
        ...
        public boolean removeIf(final Predicate<? super T> filter) {
            ...
            return this.fromList.removeIf(element -> filter.test((Object)this.function.apply((Object)element)));
        }
    }
