...
package rp.org.apache.commons.logging;
...
public abstract class LogFactory
{
    ...
    public static final String FACTORY_PROPERTY = "rp.org.apache.commons.logging.LogFactory";
    public static final String FACTORY_DEFAULT = "rp.org.apache.commons.logging.impl.LogFactoryImpl";
    public static final String FACTORY_PROPERTIES = "commons-logging.properties";
    protected static final String SERVICE_ID = "META-INF/services/org.apache.commons.logging.LogFactory";
    public static final String DIAGNOSTICS_DEST_PROPERTY = "rp.org.apache.commons.logging.diagnostics.dest";
    private static PrintStream diagnosticsStream;
    private static final String diagnosticPrefix;
    public static final String HASHTABLE_IMPLEMENTATION_PROPERTY = "rp.org.apache.commons.logging.LogFactory.HashtableImpl";
    private static final String WEAK_HASHTABLE_CLASSNAME = "rp.org.apache.commons.logging.impl.WeakHashtable";
    ...
    private static final Hashtable createFactoryStore() {
        ...
        try {
            storeImplementationClass = getSystemProperty("rp.org.apache.commons.logging.LogFactory.HashtableImpl", null);
        }
        catch (SecurityException ex) {
            storeImplementationClass = null;
        }
        if (storeImplementationClass == null) {
            storeImplementationClass = "rp.org.apache.commons.logging.impl.WeakHashtable";
        }
        try {
            ...
            handleThrowable(t);
            if (!"rp.org.apache.commons.logging.impl.WeakHashtable".equals(storeImplementationClass)) {
    ...
    public static LogFactory getFactory() throws LogConfigurationException {
        ...
        try {
            final String factoryClass = getSystemProperty("rp.org.apache.commons.logging.LogFactory", null);
            if (factoryClass != null) {
                if (isDiagnosticsEnabled()) {
                    logDiagnostic("[LOOKUP] Creating an instance of LogFactory class '" + factoryClass + "' as specified by system property " + "rp.org.apache.commons.logging.LogFactory");
                }
        ...
        if (factory == null) {
            if (props != null) {
                ...
                final String factoryClass = props.getProperty("rp.org.apache.commons.logging.LogFactory");
                if (factoryClass != null) {
                    if (isDiagnosticsEnabled()) {
        ...
        if (factory == null) {
            ...
            factory = newFactory("rp.org.apache.commons.logging.impl.LogFactoryImpl", LogFactory.thisClassLoader, contextClassLoader);
        }
        if (factory != null) {
        ...
        if (logFactoryClass != null) {
            try {
                ...
                if (logFactoryClassLoader == null) {
                    ...
                    final Class factoryFromCustomLoader = Class.forName("rp.org.apache.commons.logging.LogFactory", false, logFactoryClassLoader);
    ...
    private static PrintStream initDiagnostics() {
        String dest;
        try {
            dest = getSystemProperty("rp.org.apache.commons.logging.diagnostics.dest", null);
            if (dest == null) {
                return null;
            }
        }
