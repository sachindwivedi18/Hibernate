...
public final class Multisets
{
    ...
    static boolean equalsImpl(final Multiset<?> multiset, final Object object) {
        if (object == multiset) {
            return true;
        }
    ...
    static <E> Spliterator<E> spliteratorImpl(final Multiset<E> multiset) {
        ...
        return CollectSpliterators.flatMap(entrySpliterator, entry -> Collections.nCopies(entry.getCount(), (Object)entry.getElement()).spliterator(), 0x40 | (entrySpliterator.characteristics() & 0x510), multiset.size());
    }
