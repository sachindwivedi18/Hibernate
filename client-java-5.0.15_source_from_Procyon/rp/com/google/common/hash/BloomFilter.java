...
import rp.com.google.common.primitives.UnsignedBytes;
import rp.com.google.common.primitives.SignedBytes;
import java.io.DataOutputStream;
import java.io.OutputStream;
import java.util.stream.Collector;
import rp.com.google.common.base.Objects;
import rp.com.google.common.annotations.VisibleForTesting;
import rp.com.google.common.math.DoubleMath;
...
public final class BloomFilter<T> implements Predicate<T>, Serializable
{
    ...
    {
         <T> boolean put(final T p0, final Funnel<? super T> p1, final int p2, final BloomFilterStrategies.LockFreeBitArray p3);
        
         <T> boolean mightContain(final T p0, final Funnel<? super T> p1, final int p2, final BloomFilterStrategies.LockFreeBitArray p3);
