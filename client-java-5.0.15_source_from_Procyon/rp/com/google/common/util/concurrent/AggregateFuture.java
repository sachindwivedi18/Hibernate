...
abstract class AggregateFuture<InputT, OutputT> extends TrustedFuture<OutputT>
{
    ...
    protected String pendingToString() {
        ...
        final ImmutableCollection<? extends ListenableFuture<? extends InputT>> localFutures = localRunningState.futures;
    ...
    abstract class RunningState extends AggregateFutureState implements Runnable
    {
        ...
        abstract void collectOneValue(final boolean p0, final int p1, final InputT p2);
