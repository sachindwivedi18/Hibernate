...
final class CollectSpliterators
{
    ...
    static <T> Spliterator<T> indexed(final int size, final int extraCharacteristics, final IntFunction<T> function, final Comparator<? super T> comparator) {
        ...
        class 1WithCharacteristics implements Spliterator<T>
        {
            ...
            1WithCharacteristics(final OfInt delegate, final OfInt val$comparator) {
            ...
            public Spliterator<T> trySplit() {
                ...
                return (split == null) ? null : new 1WithCharacteristics(split, function, extraCharacteristics, this.val$comparator);
            }
        ...
        return new 1WithCharacteristics();
    }
    ...
    static <F, T> Spliterator<T> flatMap(final Spliterator<F> fromSpliterator, final Function<? super F, Spliterator<T>> function, final int topCharacteristics, final long topSize) {
        ...
        class 1FlatMapSpliterator implements Spliterator<T>
        {
            ...
            1FlatMapSpliterator(final Spliterator prefix, final Spliterator<T> from, final Spliterator<F> characteristics, final int estimatedSize, final long p5) {
                // 
                // This method could not be decompiled.
                // 
                // Original Bytecode:
                // 
                //     3: putfield        rp/com/google/common/collect/CollectSpliterators$1FlatMapSpliterator.val$function:Ljava/util/function/Function;
                //     6: aload_0         /* this */
                //     7: invokespecial   java/lang/Object.<init>:()V
                //    10: aload_0         /* this */
                //    11: aload_1         /* prefix */
                //    12: putfield        rp/com/google/common/collect/CollectSpliterators$1FlatMapSpliterator.prefix:Ljava/util/Spliterator;
                //    15: aload_0         /* this */
                //    16: aload_2         /* from */
                //    17: putfield        rp/com/google/common/collect/CollectSpliterators$1FlatMapSpliterator.from:Ljava/util/Spliterator;
                //    20: aload_0         /* this */
                //    21: iload_3         /* characteristics */
                //    22: putfield        rp/com/google/common/collect/CollectSpliterators$1FlatMapSpliterator.characteristics:I
                //    25: aload_0         /* this */
                //    26: lload           estimatedSize
                //    28: putfield        rp/com/google/common/collect/CollectSpliterators$1FlatMapSpliterator.estimatedSize:J
                //    31: return         
                //    Signature:
            ...
            public Spliterator<T> trySplit() {
                ...
                if (fromSplit != null) {
                    ...
                    final Spliterator<T> result = new 1FlatMapSpliterator(this.prefix, fromSplit, splitCharacteristics, estSplitSize, this.val$function);
                    this.prefix = null;
                    return result;
                }
                if (this.prefix != null) {
        ...
        return new 1FlatMapSpliterator(null, fromSpliterator, topCharacteristics, topSize, function);
    }
}
