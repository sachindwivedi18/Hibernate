...
public final class Tables
{
    ...
    public static <T, R, C, V, I extends Table<R, C, V>> Collector<T, ?, I> toTable(final java.util.function.Function<? super T, ? extends R> rowFunction, final java.util.function.Function<? super T, ? extends C> columnFunction, final java.util.function.Function<? super T, ? extends V> valueFunction, final Supplier<I> tableSupplier) {
        ...
        return toTable((java.util.function.Function<? super T, ?>)rowFunction, (java.util.function.Function<? super T, ?>)columnFunction, (java.util.function.Function<? super T, ?>)valueFunction, (v1, v2) -> {
            new IllegalStateException("Conflicting values " + v1 + " and " + v2);
            throw ex;
        }, tableSupplier);
    }
    ...
    public static <T, R, C, V, I extends Table<R, C, V>> Collector<T, ?, I> toTable(final java.util.function.Function<? super T, ? extends R> rowFunction, final java.util.function.Function<? super T, ? extends C> columnFunction, final java.util.function.Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction, final Supplier<I> tableSupplier) {
        ...
        return (Collector<T, ?, I>)Collector.of((Supplier<?>)tableSupplier, (table, input) -> merge(table, rowFunction.apply((Object)input), columnFunction.apply((Object)input), (V)valueFunction.apply((Object)input), mergeFunction), (table1, table2) -> {
            table2.cellSet().iterator();
            while (iterator.hasNext()) {
                cell2 = iterator.next();
                merge(table1, cell2.getRowKey(), cell2.getColumnKey(), cell2.getValue(), (BinaryOperator<Object>)mergeFunction);
            }
            return table1;
    ...
    @Beta
    public static <R, C, V> Table<R, C, V> newCustomTable(final Map<R, Map<C, V>> backingMap, final rp.com.google.common.base.Supplier<? extends Map<C, V>> factory) {
