...
public final class ByteStreams
{
    ...
    private static byte[] toByteArrayInternal(final InputStream in, final Deque<byte[]> bufs, int totalLen) throws IOException {
        int bufSize = 8192;
    ...
    static byte[] toByteArray(final InputStream in, final long expectedSize) throws IOException {
        ...
        final Deque<byte[]> bufs = new ArrayDeque<byte[]>(22);
        bufs.add(bytes);
