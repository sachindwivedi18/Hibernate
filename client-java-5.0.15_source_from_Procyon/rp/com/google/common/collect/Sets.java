...
public final class Sets
{
    ...
    public static <E> SetView<E> intersection(final Set<E> set1, final Set<?> set2) {
        ...
        return new SetView<E>() {
            ...
            @Override
            public Stream<E> stream() {
                return (Stream<E>)set1.stream().filter(set2::contains);
            }
            
            @Override
            public Stream<E> parallelStream() {
                return (Stream<E>)set1.parallelStream().filter(set2::contains);
            }
    ...
    public static <E> Set<E> filter(final Set<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
        if (unfiltered instanceof SortedSet) {
            return (Set<E>)filter((SortedSet<Object>)(SortedSet)unfiltered, (rp.com.google.common.base.Predicate<? super Object>)predicate);
        }
        if (unfiltered instanceof FilteredSet) {
            final FilteredSet<E> filtered = (FilteredSet<E>)(FilteredSet)unfiltered;
            final rp.com.google.common.base.Predicate<E> combinedPredicate = Predicates.and(filtered.predicate, predicate);
    ...
    public static <E> SortedSet<E> filter(final SortedSet<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
        if (unfiltered instanceof FilteredSet) {
            final FilteredSet<E> filtered = (FilteredSet<E>)(FilteredSet)unfiltered;
            final rp.com.google.common.base.Predicate<E> combinedPredicate = Predicates.and(filtered.predicate, predicate);
    ...
    @GwtIncompatible
    public static <E> NavigableSet<E> filter(final NavigableSet<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
        if (unfiltered instanceof FilteredSet) {
            final FilteredSet<E> filtered = (FilteredSet<E>)(FilteredSet)unfiltered;
            final rp.com.google.common.base.Predicate<E> combinedPredicate = Predicates.and(filtered.predicate, predicate);
    ...
    private static final class Accumulator<E extends Enum<E>>
    {
        ...
        static {
            TO_IMMUTABLE_ENUM_SET = Collector.of(Accumulator::new, Accumulator::add, Accumulator::combine, Accumulator::toImmutableSet, Collector.Characteristics.UNORDERED);
        }
    }
    ...
    {
        FilteredSet(final Set<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
    ...
    {
        FilteredSortedSet(final SortedSet<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
            super(unfiltered, predicate);
        }
        ...
        public SortedSet<E> subSet(final E fromElement, final E toElement) {
            return new FilteredSortedSet((SortedSet<Object>)((SortedSet)this.unfiltered).subSet(fromElement, toElement), (rp.com.google.common.base.Predicate<? super Object>)this.predicate);
        }
        
        @Override
        public SortedSet<E> headSet(final E toElement) {
            return new FilteredSortedSet((SortedSet<Object>)((SortedSet)this.unfiltered).headSet(toElement), (rp.com.google.common.base.Predicate<? super Object>)this.predicate);
        }
        
        @Override
        public SortedSet<E> tailSet(final E fromElement) {
            return new FilteredSortedSet((SortedSet<Object>)((SortedSet)this.unfiltered).tailSet(fromElement), (rp.com.google.common.base.Predicate<? super Object>)this.predicate);
        }
    ...
    {
        FilteredNavigableSet(final NavigableSet<E> unfiltered, final rp.com.google.common.base.Predicate<? super E> predicate) {
            super(unfiltered, predicate);
        }
