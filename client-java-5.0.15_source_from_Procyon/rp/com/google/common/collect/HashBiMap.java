...
public final class HashBiMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> implements BiMap<K, V>, Serializable
{
    ...
    private void insert(final BiEntry<K, V> entry, final BiEntry<K, V> oldEntryForKey) {
        final int keyBucket = entry.keyHash & this.mask;
    ...
    private BiEntry<K, V> seekByKey(final Object key, final int keyHash) {
    ...
    private BiEntry<K, V> seekByValue(final Object value, final int valueHash) {
    ...
    private V put(final K key, final V value, final boolean force) {
    ...
    private K putInverse(final V value, final K key, final boolean force) {
        final int valueHash = Hashing.smearedHash(value);
        final int keyHash = Hashing.smearedHash(key);
        final BiEntry<K, V> oldEntryForValue = this.seekByValue(value, valueHash);
        final BiEntry<K, V> oldEntryForKey = this.seekByKey(key, keyHash);
    ...
    private final class Inverse extends Maps.IteratorBasedAbstractMap<V, K> implements BiMap<V, K>, Serializable
    {
        ...
        @Override
        public K get(final Object value) {
        ...
        @Override
        public K forcePut(final V value, final K key) {
            return (K)HashBiMap.this.putInverse(value, key, true);
        }
        
        @Override
        public K remove(final Object value) {
