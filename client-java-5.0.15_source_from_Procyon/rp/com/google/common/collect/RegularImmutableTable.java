...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V>
{
    ...
    static <R, C, V> RegularImmutableTable<R, C, V> forCells(final List<Table.Cell<R, C, V>> cells, final Comparator<? super R> rowComparator, final Comparator<? super C> columnComparator) {
    ...
    private static <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(final Iterable<Table.Cell<R, C, V>> cells, final Comparator<? super R> rowComparator, final Comparator<? super C> columnComparator) {
