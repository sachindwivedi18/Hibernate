...
import rp.com.google.common.collect.MultimapBuilder;
import rp.com.google.common.collect.SetMultimap;
...
import rp.com.google.common.io.CharSource;
...
public final class ClassPath
{
    ...
    abstract static class Scanner
    {
        ...
        @VisibleForTesting
        static ImmutableSet<File> getClassPathFromManifest(final File jarFile, final Manifest manifest) {
            if (manifest == null) {
    ...
    static final class DefaultScanner extends Scanner
    {
        ...
        private void scanDirectory(final File directory, final ClassLoader classloader, final String packagePrefix, final Set<File> currentPath) throws IOException {
