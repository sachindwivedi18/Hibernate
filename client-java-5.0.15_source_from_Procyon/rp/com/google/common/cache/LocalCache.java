...
import rp.com.google.common.collect.AbstractSequentialIterator;
import rp.com.google.common.util.concurrent.SettableFuture;
import java.lang.ref.Reference;
import java.util.concurrent.Future;
import rp.com.google.common.util.concurrent.Uninterruptibles;
import rp.com.google.common.util.concurrent.MoreExecutors;
import rp.com.google.common.util.concurrent.ListenableFuture;
import rp.com.google.common.util.concurrent.Futures;
...
import rp.com.google.common.util.concurrent.ExecutionError;
import rp.com.google.common.util.concurrent.UncheckedExecutionException;
import rp.com.google.common.base.Stopwatch;
...
import rp.com.google.common.base.Ticker;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>
{
    ...
    public V computeIfAbsent(final K key, final Function<? super K, ? extends V> function) {
        Preconditions.checkNotNull(key);
        Preconditions.checkNotNull(function);
        return this.compute(key, (k, oldValue) -> (oldValue == null) ? function.apply((Object)key) : oldValue);
    }
    ...
    public V computeIfPresent(final K key, final BiFunction<? super K, ? super V, ? extends V> function) {
        Preconditions.checkNotNull(key);
        Preconditions.checkNotNull(function);
        return this.compute(key, (k, oldValue) -> (oldValue == null) ? null : function.apply((Object)k, (Object)oldValue));
    }
    ...
    public V merge(final K key, final V newValue, final BiFunction<? super V, ? super V, ? extends V> function) {
        ...
        Preconditions.checkNotNull(function);
        return this.compute(key, (k, oldValue) -> (oldValue == null) ? newValue : function.apply((Object)oldValue, (Object)newValue));
    }
        ...
        V compute(final K key, final int hash, final BiFunction<? super K, ? super V, ? extends V> function) {
            ...
            try {
                ...
                if (newValue != null) {
                    ...
                    try {
                        return (V)this.getAndRecordStats(key, hash, (LoadingValueReference<K, Object>)loadingValueReference, (ListenableFuture<Object>)Futures.immediateFuture(newValue));
                    }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V>
    {
        ...
        public ListenableFuture<V> loadFuture(final K key, final CacheLoader<? super K, V> loader) {
            try {
                ...
                return Futures.transform(newValue2, (rp.com.google.common.base.Function<? super V, ? extends V>)new rp.com.google.common.base.Function<V, V>() {
                    @Override
    ...
    final class Values extends AbstractCollection<V>
    {
        ...
        public boolean removeIf(final Predicate<? super V> filter) {
            Preconditions.checkNotNull(filter);
            return LocalCache.this.removeIf((k, v) -> filter.test((Object)v));
        }
    ...
    final class EntrySet extends AbstractCacheSet<Map.Entry<K, V>>
    {
        ...
        public boolean removeIf(final Predicate<? super Map.Entry<K, V>> filter) {
            Preconditions.checkNotNull(filter);
            return LocalCache.this.removeIf((k, v) -> filter.test((Object)Maps.immutableEntry(k, v)));
        }
