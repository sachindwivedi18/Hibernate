            ...
            switch (this.size) {
                ...
                default: {
                    if (this.valueComparator != null) {
                        ...
                        Arrays.sort(this.entries, 0, this.size, (Comparator<? super Map.Entry<K, V>>)Ordering.from(this.valueComparator).onResultOf((rp.com.google.common.base.Function<Map.Entry<?, ? extends V>, ? extends V>)Maps.valueFunction()));
                    }
