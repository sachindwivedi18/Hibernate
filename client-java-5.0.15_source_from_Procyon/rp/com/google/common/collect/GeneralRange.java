...
final class GeneralRange<T> implements Serializable
{
    ...
    private GeneralRange(final Comparator<? super T> comparator, final boolean hasLowerBound, final T lowerEndpoint, final BoundType lowerBoundType, final boolean hasUpperBound, final T upperEndpoint, final BoundType upperBoundType) {
