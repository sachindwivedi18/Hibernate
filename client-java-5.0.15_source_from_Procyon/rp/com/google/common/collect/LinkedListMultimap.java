...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable
{
    ...
    private Node<K, V> addNode(final K key, final V value, final Node<K, V> nextSibling) {
    ...
    private void removeAllNodes(final Object key) {
        Iterators.clear(new ValueForKeyIterator(key));
    }
    
    private static void checkElement(final Object node) {
        if (node == null) {
    ...
    private List<V> getCopy(final Object key) {
