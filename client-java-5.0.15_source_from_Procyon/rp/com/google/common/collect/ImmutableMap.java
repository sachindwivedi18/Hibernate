...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable
{
    ...
    public static class Builder<K, V>
    {
        ...
        public ImmutableMap<K, V> build() {
            if (this.valueComparator != null) {
                ...
                Arrays.sort(this.entries, 0, this.size, (Comparator<? super Entry<K, V>>)Ordering.from(this.valueComparator).onResultOf((rp.com.google.common.base.Function<Entry<?, ? extends V>, ? extends V>)Maps.valueFunction()));
            }
            switch (this.size) {
                case 0: {
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>>
    {
        ...
        @Override
        public ImmutableSet<V> get(final Object key) {
