...
import rp.com.google.common.primitives.Longs;

enum BloomFilterStrategies implements BloomFilter.Strategy
{
    MURMUR128_MITZ_32 {
        @Override
        public <T> boolean put(final T object, final Funnel<? super T> funnel, final int numHashFunctions, final LockFreeBitArray bits) {
        ...
        @Override
        public <T> boolean mightContain(final T object, final Funnel<? super T> funnel, final int numHashFunctions, final LockFreeBitArray bits) {
            final long bitSize = bits.bitSize();
            final long hash64 = Hashing.murmur3_128().hashObject(object, funnel).asLong();
            final int hash65 = (int)hash64;
            final int hash66 = (int)(hash64 >>> 32);
