...
import rp.com.google.common.primitives.Booleans;
...
public abstract class ComparisonChain
{
    ...
    public abstract <T> ComparisonChain compare(final T p0, final T p1, final Comparator<T> p2);
    ...
    static {
        ACTIVE = new ComparisonChain() {
            ...
            @Override
            public <T> ComparisonChain compare(final T left, final T right, final Comparator<T> comparator) {
