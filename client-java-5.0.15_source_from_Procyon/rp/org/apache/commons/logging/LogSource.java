...
import rp.org.apache.commons.logging.impl.NoOpLog;
...
public class LogSource
{
    ...
    static {
        ...
        try {
            LogSource.jdk14IsAvailable = (null != Class.forName("java.util.logging.Logger") && null != Class.forName("rp.org.apache.commons.logging.impl.Jdk14Logger"));
        }
        catch (Throwable t) {
            LogSource.jdk14IsAvailable = false;
        }
        String name = null;
        try {
            name = System.getProperty("rp.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("rp.org.apache.commons.logging.Log");
            }
        }
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation("rp.org.apache.commons.logging.impl.NoOpLog");
                }
                catch (Throwable t4) {}
            }
        }
            ...
            try {
                if (LogSource.log4jIsAvailable) {
                    setLogImplementation("rp.org.apache.commons.logging.impl.Log4JLogger");
                }
                else if (LogSource.jdk14IsAvailable) {
                    setLogImplementation("rp.org.apache.commons.logging.impl.Jdk14Logger");
                }
                else {
                    setLogImplementation("rp.org.apache.commons.logging.impl.NoOpLog");
                }
