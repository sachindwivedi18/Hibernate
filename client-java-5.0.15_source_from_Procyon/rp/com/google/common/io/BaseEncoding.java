...
import rp.com.google.common.base.Ascii;
...
public abstract class BaseEncoding
{
    ...
    static class StandardBaseEncoding extends BaseEncoding
    {
        ...
        StandardBaseEncoding(final String name, final String alphabetChars, final Character paddingChar) {
            this(new Alphabet(name, alphabetChars.toCharArray()), paddingChar);
        }
        
        StandardBaseEncoding(final Alphabet alphabet, final Character paddingChar) {
        ...
        BaseEncoding newInstance(final Alphabet alphabet, final Character paddingChar) {
    ...
    {
        Base64Encoding(final String name, final String alphabetChars, final Character paddingChar) {
            this(new Alphabet(name, alphabetChars.toCharArray()), paddingChar);
        }
        
        private Base64Encoding(final Alphabet alphabet, final Character paddingChar) {
