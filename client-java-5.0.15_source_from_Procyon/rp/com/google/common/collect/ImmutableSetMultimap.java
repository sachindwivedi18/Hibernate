...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V>
{
    ...
    static <K, V> ImmutableSetMultimap<K, V> fromMapEntries(final Collection<? extends Map.Entry<? extends K, ? extends Collection<? extends V>>> mapEntries, final Comparator<? super V> valueComparator) {
    ...
    ImmutableSetMultimap(final ImmutableMap<K, ImmutableSet<V>> map, final int size, final Comparator<? super V> valueComparator) {
    ...
    private static <V> ImmutableSet<V> valueSet(final Comparator<? super V> valueComparator, final Collection<? extends V> values) {
    ...
    private static <V> ImmutableSet<V> emptySet(final Comparator<? super V> valueComparator) {
    ...
    private static <V> ImmutableSet.Builder<V> valuesBuilder(final Comparator<? super V> valueComparator) {
