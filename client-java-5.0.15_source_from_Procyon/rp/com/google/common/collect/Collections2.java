...
public final class Collections2
{
    ...
    static class FilteredCollection<E> extends AbstractCollection<E>
    {
        ...
        public boolean removeIf(final java.util.function.Predicate<? super E> filter) {
            ...
            return this.unfiltered.removeIf(element -> this.predicate.apply((Object)element) && filter.test((Object)element));
        }
        ...
        public int size() {
            ...
            for (final E e : this.unfiltered) {
                if (this.predicate.apply((Object)e)) {
                    ++size;
                }
            }
            return size;
    ...
    static class TransformedCollection<F, T> extends AbstractCollection<T>
    {
        ...
        public void forEach(final Consumer<? super T> action) {
            Preconditions.checkNotNull(action);
            this.fromCollection.forEach(f -> action.accept((Object)this.function.apply((Object)f)));
        }
        
        @Override
        public boolean removeIf(final java.util.function.Predicate<? super T> filter) {
            Preconditions.checkNotNull(filter);
            return this.fromCollection.removeIf(element -> filter.test((Object)this.function.apply((Object)element)));
        }
