...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V>
{
    ...
    private static <K extends Comparable, V> Range<K> coalesce(final Range<K> range, final V value, final Map.Entry<Cut<K>, RangeMapEntry<K, V>> entry) {
    ...
    static {
        EMPTY_SUB_RANGE_MAP = new RangeMap() {
            ...
            @Override
            public void putCoalescing(final Range range, final Object value) {
                Preconditions.checkNotNull(range);
                throw new IllegalArgumentException("Cannot insert range " + range + " into an empty subRangeMap");
            }
