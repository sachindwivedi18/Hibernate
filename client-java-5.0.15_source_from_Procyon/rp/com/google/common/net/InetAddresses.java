...
package rp.com.google.common.net;

import rp.com.google.common.base.MoreObjects;
import java.util.Locale;
import rp.com.google.common.hash.Hashing;
...
public final class InetAddresses
{
    ...
    private static byte[] textToNumericFormatV6(final String ipString) {
        final List<String> parts = InetAddresses.IPV6_SPLITTER.splitToList(ipString);
    ...
    public static final class TeredoInfo
    {
        ...
        public TeredoInfo(final Inet4Address server, final Inet4Address client, final int port, final int flags) {
