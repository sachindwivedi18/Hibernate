...
package rp.org.apache.commons.logging.impl;
...
import rp.org.apache.commons.logging.LogConfigurationException;
...
{
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "rp.org.apache.commons.logging.impl.Log4JLogger";
    private static final String LOGGING_IMPL_JDK14_LOGGER = "rp.org.apache.commons.logging.impl.Jdk14Logger";
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "rp.org.apache.commons.logging.impl.Jdk13LumberjackLogger";
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "rp.org.apache.commons.logging.impl.SimpleLog";
    private static final String PKG_IMPL = "rp.org.apache.commons.logging.impl.";
    private static final int PKG_LEN;
    public static final String LOG_PROPERTY = "rp.org.apache.commons.logging.Log";
    protected static final String LOG_PROPERTY_OLD = "rp.org.apache.commons.logging.log";
    public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = "rp.org.apache.commons.logging.Log.allowFlawedContext";
    public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = "rp.org.apache.commons.logging.Log.allowFlawedDiscovery";
    public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = "rp.org.apache.commons.logging.Log.allowFlawedHierarchy";
    ...
    protected boolean isJdk13LumberjackAvailable() {
        return this.isLogLibraryAvailable("Jdk13Lumberjack", "rp.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
    }
    
    protected boolean isJdk14Available() {
        return this.isLogLibraryAvailable("Jdk14", "rp.org.apache.commons.logging.impl.Jdk14Logger");
    }
    
    protected boolean isLog4JAvailable() {
        return this.isLogLibraryAvailable("Log4J", "rp.org.apache.commons.logging.impl.Log4JLogger");
    }
    ...
    private void initConfiguration() {
        this.allowFlawedContext = this.getBooleanConfiguration("rp.org.apache.commons.logging.Log.allowFlawedContext", true);
        this.allowFlawedDiscovery = this.getBooleanConfiguration("rp.org.apache.commons.logging.Log.allowFlawedDiscovery", true);
        this.allowFlawedHierarchy = this.getBooleanConfiguration("rp.org.apache.commons.logging.Log.allowFlawedHierarchy", true);
    }
    ...
    private Log discoverLogImplementation(final String logCategory) throws LogConfigurationException {
        ...
        if (specifiedLogClassName != null) {
            ...
            if (result == null) {
                ...
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "rp.org.apache.commons.logging.impl.Log4JLogger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "rp.org.apache.commons.logging.impl.Jdk14Logger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "rp.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "rp.org.apache.commons.logging.impl.SimpleLog");
    ...
    private String findUserSpecifiedLogClassName() {
        ...
        String specifiedClass = (String)this.getAttribute("rp.org.apache.commons.logging.Log");
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
                this.logDiagnostic("Trying to get log class from attribute 'org.apache.commons.logging.log'");
            }
            specifiedClass = (String)this.getAttribute("rp.org.apache.commons.logging.log");
        }
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
            ...
            try {
                specifiedClass = getSystemProperty("rp.org.apache.commons.logging.Log", null);
            }
            catch (SecurityException e) {
                if (isDiagnosticsEnabled()) {
    ...
    static {
        PKG_LEN = "rp.org.apache.commons.logging.impl.".length();
        classesToDiscover = new String[] { "rp.org.apache.commons.logging.impl.Log4JLogger", "rp.org.apache.commons.logging.impl.Jdk14Logger", "rp.org.apache.commons.logging.impl.Jdk13LumberjackLogger", "rp.org.apache.commons.logging.impl.SimpleLog" };
    }
}
