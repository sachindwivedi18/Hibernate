...
public abstract class AbstractFuture<V> extends FluentFuture<V>
{
    ...
    public boolean cancel(final boolean mayInterruptIfRunning) {
        ...
        if (localValue == null | localValue instanceof SetFuture) {
            final Object valueToSet = AbstractFuture.GENERATE_CANCELLATION_CAUSES ? new Cancellation(mayInterruptIfRunning, new CancellationException("Future.cancel() was called.")) : (mayInterruptIfRunning ? Cancellation.CAUSELESS_INTERRUPTED : Cancellation.CAUSELESS_CANCELLED);
    ...
    final void maybePropagateCancellationTo(final Future<?> related) {
    ...
    public String toString() {
        final StringBuilder builder = new StringBuilder().append(super.toString()).append("[status=");
        if (this.isCancelled()) {
    ...
    private void addDoneString(final StringBuilder builder) {
        try {
            final V value = Futures.getDone((Future<V>)this);
    ...
    private String userObjectToString(final Object o) {
        if (o == this) {
            return "this future";
        }
