...
public final class Iterators
{
    ...
    public static int frequency(final Iterator<?> iterator, final Object element) {
        int count = 0;
    ...
    private static <T> Iterator<T> consumingForArray(final T... elements) {
        return new UnmodifiableIterator<T>() {
            ...
            public T next() {
                ...
                final T result = elements[this.index];
    ...
    public static <T> T find(final Iterator<? extends T> iterator, final Predicate<? super T> predicate, final T defaultValue) {
        Preconditions.checkNotNull(iterator);
        Preconditions.checkNotNull(predicate);
        while (iterator.hasNext()) {
    ...
    public static <T> T get(final Iterator<? extends T> iterator, final int position, final T defaultValue) {
        checkNonnegative(position);
