...
public final class Iterables
{
    ...
    public static int frequency(final Iterable<?> iterable, final Object element) {
    ...
    public static <T> T find(final Iterable<? extends T> iterable, final Predicate<? super T> predicate, final T defaultValue) {
    ...
    public static <F, T> Iterable<T> transform(final Iterable<F> fromIterable, final rp.com.google.common.base.Function<? super F, ? extends T> function) {
        Preconditions.checkNotNull(fromIterable);
        Preconditions.checkNotNull(function);
        return new FluentIterable<T>() {
            @Override
            public Iterator<T> iterator() {
                return Iterators.transform(fromIterable.iterator(), (rp.com.google.common.base.Function<? super Object, ? extends T>)function);
            }
    ...
    public static <T> T get(final Iterable<? extends T> iterable, final int position, final T defaultValue) {
        Preconditions.checkNotNull(iterable);
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterables, final Comparator<? super T> comparator) {
        ...
        final Iterable<T> iterable = new FluentIterable<T>() {
            @Override
            public Iterator<T> iterator() {
                return (Iterator<T>)Iterators.mergeSorted(Iterables.transform((Iterable<Object>)iterables, (rp.com.google.common.base.Function<? super Object, ? extends Iterator<?>>)Iterables.toIterator()), (Comparator<? super Object>)comparator);
            }
        };
        return new UnmodifiableIterable<T>((Iterable)iterable);
    }
    
    static <T> rp.com.google.common.base.Function<Iterable<? extends T>, Iterator<? extends T>> toIterator() {
        return new rp.com.google.common.base.Function<Iterable<? extends T>, Iterator<? extends T>>() {
            @Override
