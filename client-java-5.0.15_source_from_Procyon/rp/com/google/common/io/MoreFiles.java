...
public final class MoreFiles
{
    ...
    private static Collection<IOException> addException(Collection<IOException> exceptions, final IOException e) {
        if (exceptions == null) {
    ...
    private static Collection<IOException> concat(final Collection<IOException> exceptions, final Collection<IOException> other) {
        if (exceptions == null) {
            return other;
        }
        if (other != null) {
